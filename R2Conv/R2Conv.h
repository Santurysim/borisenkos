...
public:
    ...
    R2ConvexException(const char *cause):
        reason(cause)
    {}
};
...
public:
    ...
    public:
        ...
        iterator(const R2PointDeq::iterator& i):
            R2PointDeq::iterator(i)
        {}
    };
    class const_iterator: public R2PointDeq::const_iterator {
    public:
        const_iterator():
            R2PointDeq::const_iterator()
        {}
...
public:
    ...
    public:
        ...
        iterator operator++(int) { // Postfix increment operator
            iterator tmp = *this;
            operator++(); // Сall the prefix operator
            return tmp;
        }
    ...
    const_iterator begin() const {
        ...
        if (m_NumAng >= 3) {
            res.polygon_iterator = 
                ((const R2Polygon*) m_Polygon)->begin();
        }
        return res;
    }
